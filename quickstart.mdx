...
<Tabs>
  ...
  <Tab title="Email">
    ...
    console.log('Email sent:', response.data.email_id);
    ```
  ...
  <Tab title="iMessage">
    ...
    console.log('iMessage sent:', response.data.message_id);
    ```
  </Tab>
  ...
  <Tab title="WhatsApp">
    ...
    console.log('WhatsApp message sent:', response.data.message_id);
    ```
  </Tab>
</Tabs>
